...
public class EditNotesFragment extends BaseFragment implements IEditNotesView {
    ...
    protected void bindViews() {
        ...
        NotesModel notesModel = getArguments().getParcelable(Constants.BundleKeys.NOTES_DATA);
        vEtNoteTitle.setText(notesModel.getNoteTitle());
        vEtNoteBody.setTransitionName(getArguments().getString(Constants.BundleKeys.EXTRA_TITLE_TRANSITION_NAME));
